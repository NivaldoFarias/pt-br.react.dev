...
Introduzimos [React Canaries](/blog/2023/05/03/react-canaries) como uma opção para adotar recursos estáveis individuais e novos assim que seu design estiver próximo de ser finalizado, antes de serem lançados em uma versão semântica estável.
...
React Server Components, Asset Loading, Document Metadata e Actions já foram incorporados ao React Canary, e adicionamos documentação para esses recursos em react.dev:
