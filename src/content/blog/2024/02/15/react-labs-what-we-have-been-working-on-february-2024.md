...
O Compilador React não é mais um projeto de pesquisa: o compilador agora impulsiona o instagram.com em produção, e estamos trabalhando para lançar o compilador em superfícies adicionais na Meta e para preparar o primeiro lançamento de código aberto.
...
Obrigado pela leitura e [vemo-nos na React Conf](https://conf.react.dev/)!