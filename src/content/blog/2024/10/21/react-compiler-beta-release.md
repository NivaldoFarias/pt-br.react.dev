...
author: Lauren Tan
date: 2024/10/21
description: Na React Conf 2024, anunciamos o lançamento experimental do React Compiler, uma ferramenta de build-time que otimiza seu app React através de memoização automática. Neste post, queremos compartilhar o que vem a seguir para o código aberto e nosso progresso com o compilador.
...
### React Compiler está agora em RC! {/*react-compiler-is-now-in-rc*/}
...
2. Estamos oferecendo suporte oficial ao React Compiler para apps no React 17+, através de um pacote opcional `react-compiler-runtime`.
...
Na [React Conf 2024](/blog/2024/05/22/react-conf-2024-recap), anunciamos o lançamento experimental do React Compiler, uma ferramenta de build-time que otimiza seu app React através de memoização automática. [Você pode encontrar uma introdução ao React Compiler aqui](/learn/react-compiler).

Desde o primeiro lançamento, corrigimos inúmeros bugs relatados pela comunidade React, recebemos várias correções de bugs e contribuições de alta qualidade[^1] para o compilador, tornamos o compilador mais resiliente à ampla diversidade de padrões JavaScript e continuamos a implantar o compilador mais amplamente na Meta.
...
Após a instalação, você pode habilitar o linter [adicionando-o à sua configuração ESLint](/learn/react-compiler/installation#eslint-integration). Usar o linter ajuda a identificar quebras nas Regras do React, tornando mais fácil adotar o compilador quando ele for totalmente lançado.
...
* ✅ Experimental: Lançado na React Conf 2024, principalmente para feedback de primeiros adotantes.
...
* 🚧 Disponibilidade Geral: Após o período final de feedback da comunidade.
...
Ao longo deste processo, também planejamos prototipar uma extensão IDE para React. Ainda está muito no início da pesquisa, então esperamos poder compartilhar mais de nossas descobertas com você em um futuro post do blog do React Labs.
...
[^3]: Após controlar o tempo de experiência do autor, o comprimento/complexidade das diferenças e outros fatores potenciais de confusão.