...
Nosso lançamento inicial foi focado em identificar problemas importantes com o uso do compilador em aplicações. Recebemos ótimos feedbacks e melhoramos substancialmente o compilador desde então. Agora estamos prontos para feedback amplo da comunidade, e para que os autores de bibliotecas experimentem o compilador para melhorar o desempenho e a experiência do desenvolvedor na manutenção de sua biblioteca.
...
A partir de hoje, juntamente com o lançamento Beta do React Compiler, estamos abrindo a adesão ao Grupo de Trabalho para todos. O objetivo do Grupo de Trabalho do React Compiler é preparar o ecossistema para uma adoção suave e gradual do React Compiler por aplicações e bibliotecas existentes. Por favor, continue a registrar relatórios de bugs no [repositório do React](https://github.com/facebook/react), mas por favor, deixe feedback, faça perguntas ou compartilhe ideias no [fórum de discussão do Grupo de Trabalho](https://github.com/reactwg/react-compiler/discussions).
...
[^3]: Após controlar o tempo de experiência do autor, o comprimento/complexidade das diffs e outros fatores de confusão potenciais.