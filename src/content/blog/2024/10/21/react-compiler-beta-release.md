...
author: Lauren Tan
date: 2024/10/21
description: Na React Conf 2024, anunciamos o lançamento experimental do React Compiler, uma ferramenta de build-time que otimiza seu aplicativo React através de memoização automática. Neste post, queremos compartilhar o que vem a seguir para o código aberto e nosso progresso com o compilador.
...
[^3]: Após controlar o tempo de experiência do autor, comprimento/complexidade da diff e outros fatores potenciais de confusão.