...
author: Ricky Hanlon
date: 2024/05/22
description: Na semana passada, realizamos a React Conf 2024, uma conferência de dois dias em Henderson, Nevada, onde mais de 700 participantes se reuniram pessoalmente para discutir as novidades em engenharia de UI. Neste post, vamos resumir as palestras e anúncios do evento.
---
...
Na semana passada, realizamos a React Conf 2024, uma conferência de dois dias em Henderson, Nevada, onde mais de 700 participantes se reuniram pessoalmente para discutir as novidades em engenharia de UI. Esta foi nossa primeira conferência presencial desde 2019, e ficamos muito felizes em poder reunir a comunidade novamente.

</Intro>

---

Na React Conf 2024, anunciamos o [React 19 RC](/blog/2024/12/05/react-19), a [Nova Arquitetura Beta do React Native](https://github.com/reactwg/react-native-new-architecture/discussions/189) e um lançamento experimental do [React Compiler](/learn/react-compiler). A comunidade também subiu ao palco para anunciar o [React Router v7](https://remix.run/blog/merging-remix-and-react-router), [Componentes Universais do Servidor](https://www.youtube.com/watch?v=T8TZQ6k4SLE&t=20765s) no Expo Router, React Server Components no [RedwoodJS](https://redwoodjs.com/blog/rsc-now-in-redwoodjs) e muito mais.

As transmissões completas do [dia 1](https://www.youtube.com/watch?v=T8TZQ6k4SLE) e do [dia 2](https://www.youtube.com/watch?v=0ckOUBiuxVY) estão disponíveis online. Neste post, vamos resumir as palestras e anúncios do evento.

## Dia 1 {/*day-1*/}

_[Assista à transmissão completa do dia 1 aqui.](https://www.youtube.com/watch?v=T8TZQ6k4SLE&t=973s)_

Para começar o dia 1, o CTO da Meta [Andrew "Boz" Bosworth](https://www.threads.net/@boztank) compartilhou uma mensagem de boas-vindas, seguida por uma introdução de [Seth Webster](https://twitter.com/sethwebster), que gerencia a React Org na Meta, e da nossa MC [Ashley Narcisse](https://twitter.com/_darkfadr).

Na palestra principal do dia 1, [Joe Savona](https://twitter.com/en_JS) compartilhou nossos objetivos e nossa visão para o React, para facilitar para qualquer pessoa a criação de ótimas experiências do usuário. [Lauren Tan](https://twitter.com/potetotes) compartilhou um State of React, onde ela disse que o React foi baixado mais de 1 bilhão de vezes em 2023, e que 37% dos novos desenvolvedores aprendem a programar com React. Por fim, ela destacou o trabalho da comunidade React para fazer o React, React.
...
Em seguida, na palestra principal, [Josh Story](https://twitter.com/joshcstory) e [Andrew Clark](https://twitter.com/acdlite) compartilharam os novos recursos que chegarão no React 19 e anunciaram o React 19 RC, que está pronto para testes em produção. Confira todos os recursos no [post de lançamento do React 19](/blog/2024/12/05/react-19) e assista a essas palestras para se aprofundar nos novos recursos:
...
Para começar o dia 2, [Seth Webster](https://twitter.com/sethwebster) compartilhou uma mensagem de boas-vindas, seguida por um agradecimento de [Eli White](https://x.com/Eli_White) e uma introdução da nossa Chief Vibes Officer [Ashley Narcisse](https://twitter.com/_darkfadr).

Na palestra principal do dia 2, [Nicola Corti](https://twitter.com/cortinico) compartilhou o State of React Native, incluindo 78 milhões de downloads em 2023. Ele também destacou os aplicativos que usam React Native, incluindo mais de 2000 telas usadas dentro da Meta; a página de detalhes do produto no Facebook Marketplace, que é visitada mais de 2 bilhões de vezes por dia; e parte do Menu Iniciar do Microsoft Windows e alguns recursos em quase todos os produtos do Microsoft Office em dispositivos móveis e desktop.
...
[Riccardo Cipolleschi](https://twitter.com/cipolleschir) continuou a palestra principal do dia 2, anunciando que a Nova Arquitetura do React Native agora está em Beta e pronta para os aplicativos adotarem em produção. Ele compartilhou novos recursos e melhorias na nova arquitetura e compartilhou o roteiro para o futuro do React Native. Para mais informações, confira:
...
Em seguida, na palestra principal, Nicola anunciou que agora estamos recomendando começar com um framework como o Expo para todos os novos aplicativos criados com React Native. Com a mudança, ele também anunciou uma nova página inicial do React Native e novos docs de primeiros passos. Você pode visualizar o novo guia de primeiros passos nos [docs do React Native](https://reactnative.dev/docs/next/environment-setup).

Por fim, para encerrar a palestra principal, [Kadi Kraman](https://twitter.com/kadikraman) compartilhou os recursos e melhorias mais recentes no Expo e como começar a desenvolver com React Native usando o Expo.
...
- [Perguntas e Respostas sobre React](https://www.youtube.com/watch?v=T8TZQ6k4SLE&t=27518s) apresentado por [Michael Chan](https://twitter.com/chantastic)
- [Perguntas e Respostas sobre React Native](https://www.youtube.com/watch?v=0ckOUBiuxVY&t=27935s) apresentado por [Jamon Holmgren](https://twitter.com/jamonholmgren)
...
Agradecemos a todos os funcionários, palestrantes e participantes que tornaram a React Conf 2024 possível. Há muitos para listar, mas queremos agradecer a alguns em particular.
...
Obrigado [Seth Webster](https://twitter.com/sethwebster) e [Eli White](https://x.com/Eli_White) por nos receberem todos os dias e fornecerem orientação sobre estrutura e conteúdo; e a [Tom Occhino](https://twitter.com/tomocchino) por se juntar a nós com uma mensagem especial durante a festa.
...
Obrigado à Equipe AV pelos visuais, palco e som; e ao Westin Hotel por nos receber.
