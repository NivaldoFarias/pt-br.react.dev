...
author: Ricky Hanlon
date: 2024/05/22
description: Na semana passada, fomos anfitriões da React Conf 2024, uma conferência de dois dias em Henderson, Nevada, onde mais de 700 participantes se reuniram pessoalmente para discutir as últimas novidades em engenharia de UI. Neste post, resumiremos as palestras e anúncios do evento.
---
...
Na semana passada, fomos anfitriões da React Conf 2024, uma conferência de dois dias em Henderson, Nevada, onde mais de 700 participantes se reuniram pessoalmente para discutir as últimas novidades em engenharia de UI. Esta foi a nossa primeira conferência presencial desde 2019, e ficamos muito felizes em poder reunir a comunidade novamente.

</Intro>

---

Na React Conf 2024, anunciamos o [React 19 RC](/blog/2024/12/05/react-19), a [React Native New Architecture Beta](https://github.com/reactwg/react-native-new-architecture/discussions/189), e uma versão experimental do [React Compiler](/learn/react-compiler). A comunidade também subiu ao palco para anunciar [React Router v7](https://remix.run/blog/merging-remix-and-react-router), [Universal Server Components](https://www.youtube.com/watch?v=T8TZQ6k4SLE&t=20765s) em Expo Router, React Server Components em [RedwoodJS](https://redwoodjs.com/blog/rsc-now-in-redwoodjs) e muito mais.

As transmissões completas [do dia 1](https://www.youtube.com/watch?v=T8TZQ6k4SLE) e [do dia 2](https://www.youtube.com/watch?v=0ckOUBiuxVY) estão disponíveis online. Neste post, resumiremos as palestras e anúncios do evento.

## Dia 1 {/*day-1*/}

_[Assista à transmissão completa do dia 1 aqui.](https://www.youtube.com/watch?v=T8TZQ6k4SLE&t=973s)_

Para dar início ao dia 1, o CTO da Meta [Andrew "Boz" Bosworth](https://www.threads.net/@boztank) compartilhou uma mensagem de boas-vindas, seguida por uma introdução de [Seth Webster](https://twitter.com/sethwebster), que gerencia o React Org na Meta, e nosso MC [Ashley Narcisse](https://twitter.com/_darkfadr).

Na palestra principal do dia 1, [Joe Savona](https://twitter.com/en_JS) compartilhou nossos objetivos e visão para o React, para facilitar a criação de ótimas experiências do usuário por qualquer pessoa. [Lauren Tan](https://twitter.com/potetotes) seguiu com um State of React, onde compartilhou que o React foi baixado mais de 1 bilhão de vezes em 2023, e que 37% dos novos desenvolvedores aprendem a programar com React. Por fim, ela destacou o trabalho da comunidade React para fazer React, React.
...
Em seguida, na palestra principal, [Josh Story](https://twitter.com/joshcstory) e [Andrew Clark](https://twitter.com/acdlite) compartilharam os novos recursos que virão no React 19 e anunciaram o React 19 RC, que está pronto para testes em produção. Confira todos os recursos no [post de lançamento do React 19](/blog/2024/12/05/react-19) e assista a estas palestras para mergulhos profundos nos novos recursos:
...
Para dar o pontapé inicial ao dia 2, [Seth Webster](https://twitter.com/sethwebster) compartilhou uma mensagem de boas-vindas, seguido por um agradecimento de [Eli White](https://x.com/Eli_White) e uma introdução da nossa Chief Vibes Officer [Ashley Narcisse](https://twitter.com/_darkfadr).
...
[Riccardo Cipolleschi](https://twitter.com/cipolleschir) continuou a palestra principal do dia 2, anunciando que a React Native New Architecture agora está em versão Beta e pronta para os aplicativos adotarem em produção. Ele compartilhou novos recursos e aprimoramentos na nova arquitetura e compartilhou o roteiro para o futuro do React Native. Para mais informações, confira:
...
Por fim, para encerrar a palestra principal, [Kadi Kraman](https://twitter.com/kadikraman) compartilhou os recursos e aprimoramentos mais recentes do Expo e como começar a desenvolver com React Native usando o Expo.
...
Obrigado a [Seth Webster](https://twitter.com/sethwebster) e [Eli White](https://x.com/Eli_White) por nos darem as boas-vindas todos os dias e fornecerem orientação sobre estrutura e conteúdo; e a [Tom Occhino](https://twitter.com/tomocchino) por se juntar a nós com uma mensagem especial durante a festa posterior.

Obrigado a [Ricky Hanlon](https://www.youtube.com/watch?v=FxTZL2U-uKg&t=1263s) por fornecer feedback detalhado sobre as palestras, trabalhar nos designs dos slides e, geralmente, preencher as lacunas para se dedicar aos detalhes.
