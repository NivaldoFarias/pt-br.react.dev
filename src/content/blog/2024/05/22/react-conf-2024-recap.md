...
author: Ricky Hanlon
date: 2024/05/22
description: Na semana passada, recebemos a React Conf 2024, uma conferência de dois dias em Henderson, Nevada, onde mais de 700 participantes se reuniram pessoalmente para discutir as últimas novidades em engenharia de UI. Nesta publicação, resumiremos as palestras e anúncios do evento.
---
...
Na semana passada, recebemos a React Conf 2024, uma conferência de dois dias em Henderson, Nevada, onde mais de 700 participantes se reuniram pessoalmente para discutir as últimas novidades em engenharia de UI. Esta foi nossa primeira conferência pessoalmente desde 2019, e ficamos muito felizes em poder reunir a comunidade novamente.
...
As transmissões completas do [dia 1](https://www.youtube.com/watch?v=T8TZQ6k4SLE) e [dia 2](https://www.youtube.com/watch?v=0ckOUBiuxVY) estão disponíveis online. Nesta publicação, resumiremos as palestras e anúncios do evento.

## Dia 1 {/*day-1*/}

_[Assista à transmissão completa do dia 1 aqui.](https://www.youtube.com/watch?v=T8TZQ6k4SLE&t=973s)_

Para começar o dia 1, o CTO da Meta, [Andrew "Boz" Bosworth](https://www.threads.net/@boztank), compartilhou uma mensagem de boas-vindas, seguida por uma introdução de [Seth Webster](https://twitter.com/sethwebster), que gerencia a React Org na Meta, e nosso MC [Ashley Narcisse](https://twitter.com/_darkfadr).
...
Para dar início ao dia 2, [Seth Webster](https://twitter.com/sethwebster) compartilhou uma mensagem de boas-vindas, seguida por um agradecimento de [Eli White](https://x.com/Eli_White) e uma introdução da nossa Chief Vibes Officer [Ashley Narcisse](https://twitter.com/_darkfadr).
...
Em seguida, na palestra principal, Nicola anunciou que agora estamos recomendando começar com um framework como o Expo para todos os novos aplicativos criados com React Native. Com a mudança, ele também anunciou uma nova página inicial do React Native e novos documentos Começando. Você pode visualizar o novo guia Começando nos [documentos do React Native](https://reactnative.dev/docs/next/environment-setup).
...
- [React Q&A](https://www.youtube.com/watch?v=T8TZQ6k4SLE&t=27518s) apresentada por [Michael Chan](https://twitter.com/chantastic)
- [React Native Q&A](https://www.youtube.com/watch?v=0ckOUBiuxVY&t=27935s) apresentada por [Jamon Holmgren](https://twitter.com/jamonholmgren)
...
Obrigado [Seth Webster](https://twitter.com/sethwebster) e [Eli White](https://x.com/Eli_White) por nos receberem todos os dias e fornecerem orientação sobre estrutura e conteúdo; e a [Tom Occhino](https://twitter.com/tomocchino) por se juntar a nós com uma mensagem especial durante a festa de encerramento.
...
Finalmente, obrigado a todos que compareceram pessoalmente e online para mostrar o que faz React, React. React é mais do que uma biblioteca, é uma comunidade, e foi inspirador ver todos se reunirem para compartilhar e aprender juntos.
