...
Na palestra principal (keynote), compartilhamos nossa visão para o futuro do React, começando com o React 18.

O React 18 adiciona o renderizador simultâneo (concurrent renderer) há muito aguardado e atualizações para Suspense sem nenhuma grande alteração de quebra. Os aplicativos podem atualizar para o React 18 e começar a adotar gradualmente recursos simultâneos com o mesmo esforço de qualquer outra versão principal.
...
Na palestra principal, também anunciamos que o React 18 RC está disponível para experimentar agora. Aguardando mais feedback, esta é a versão exata do React que publicaremos para estável no início do próximo ano.
...
## Keynote do React docs {/*react-docs-keynote*/}
...
* Helen Lin: [Hidrogênio + React 18](https://youtu.be/HS6vIYkSNks).
...
Obrigado a [Manjula Dube](https://twitter.com/manjula_dube), [Sahil Mhapsekar](https://twitter.com/apheri0) e Vihang Patel do [React India](https://www.reactindia.io/) e [Jasmine Xie](https://twitter.com/jasmine_xby), [QiChang Li](https://twitter.com/QCL15) e [YanLun Li](https://twitter.com/anneincoding) do [React China](https://twitter.com/ReactChina) por ajudar a moderar o nosso evento de replay e mantê-lo envolvente para a comunidade.

Obrigado à Vercel por publicar o [Virtual Event Starter Kit](https://vercel.com/virtual-event-starter-kit), no qual o site da conferência foi construído, e a [Lee Robinson](https://twitter.com/leeerob) e [Delba de Oliveira](https://twitter.com/delba_oliveira) por compartilhar sua experiência de execução da Next.js Conf.

Obrigado a [Leah Silber](https://twitter.com/wifelette) por compartilhar sua experiência de realização de conferências, aprendizados de execução da [RustConf](https://rustconf.com/) e por seu livro [Event Driven](https://leanpub.com/eventdriven/) e os conselhos que ele contém para a realização de conferências.

Obrigado a [Kevin Lewis](https://twitter.com/_phzn) e [Rachel Nabors](https://twitter.com/rachelnabors) por compartilhar sua experiência de condução da Women of React Conf.
...
Obrigado a [Dan Lebowitz](https://twitter.com/lebo) pela ajuda na criação e construção do site da conferência e ingressos.

Obrigado a Laura Podolak Waddell, Desmond Osei-Acheampong, Mark Rossi, Josh Toberman e outros membros da equipe de Produções de Vídeo do Facebook por gravar os vídeos da Keynote e das palestras dos funcionários da Meta.
