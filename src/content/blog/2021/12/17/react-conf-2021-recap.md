...
O React 18 adiciona o tão esperado renderizador concorrente e atualizações para Suspense sem nenhuma alteração significativa. Os aplicativos podem fazer o upgrade para o React 18 e começar a adotar gradualmente recursos concorrentes com uma quantidade de esforço comparável a qualquer outra versão importante.
...
e alterne para a nova API `createRoot`:
...
Para oferecer suporte aos novos recursos desta versão, também anunciamos a recém-formada equipe do React DevTools e um novo Timeline Profiler para ajudar os desenvolvedores a depurar seus aplicativos React.
...
* Robert Balicki: [Apresentando novamente o Relay](https://youtu.be/lhVGdErZuN4).
...
Obrigado a [Rachel Nabors](https://twitter.com/rachelnabors) por liderar nosso esforço de moderação, e [Aisha Blake](https://twitter.com/AishaBlake) por criar nosso guia de moderação, liderar nossa equipe de moderação, treinar os tradutores e moderadores e ajudar a moderar os dois eventos.
...
Obrigado a Vercel por publicar seu [Kit de Início de Evento Virtual](https://vercel.com/virtual-event-starter-kit), no qual o site da conferência foi construído, e a [Lee Robinson](https://twitter.com/leeerob) e [Delba de Oliveira](https://twitter.com/delba_oliveira) por compartilhar sua experiência de execução da Next.js Conf.

Obrigado a [Leah Silber](https://twitter.com/wifelette) por compartilhar sua experiência em como executar conferências, aprendizados da execução da [RustConf](https://rustconf.com/) e por seu livro [Event Driven](https://leanpub.com/eventdriven/) e os conselhos que ele contém para executar conferências.
...
Obrigado a Laura Podolak Waddell, Desmond Osei-Acheampong, Mark Rossi, Josh Toberman e outros da equipe de produção de vídeo do Facebook por gravar os vídeos das palestras principais e das palestras dos funcionários da Meta.
