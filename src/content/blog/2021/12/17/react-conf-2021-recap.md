...
## React 18 e recursos simultâneos {/*react-18-and-concurrent-features*/}

Na palestra principal, compartilhamos nossa visão para o futuro do React, começando com o React 18.

O React 18 adiciona o renderizador simultâneo há muito esperado e atualizações para Suspense sem grandes alterações significativas. Os aplicativos podem atualizar para o React 18 e começar a adotar gradualmente recursos simultâneos com o mesmo esforço de qualquer outra versão principal.

**Isso significa que não há modo simultâneo, apenas recursos simultâneos.**
...
Na palestra principal, também anunciamos que o React 18 RC está disponível para experimentar agora. Pendente feedback adicional, esta é a versão exata do React que publicaremos para estável no início do próximo ano.
...
## Renderização do servidor de transmissão com Suspense {/*streaming-server-rendering-with-suspense*/}
...
Obrigado a [Seth Webster](https://twitter.com/sethwebster) pelo feedback sobre a direção geral e por garantir que estamos focados em diversidade e inclusão.
...
Obrigado à Vercel por publicar seu [Kit de Inicialização de Eventos Virtuais](https://vercel.com/virtual-event-starter-kit), no qual o site da conferência foi construído, e a [Lee Robinson](https://twitter.com/leeerob) e [Delba de Oliveira](https://twitter.com/delba_oliveira) por compartilhar sua experiência em execução da Next.js Conf.

Obrigado a [Leah Silber](https://twitter.com/wifelette) por compartilhar sua experiência em execução de conferências, aprendizados de execução da [RustConf](https://rustconf.com/) e por seu livro [Event Driven](https://leanpub.com/eventdriven/) e os conselhos que ele contém para execução de conferências.

Obrigado a [Kevin Lewis](https://twitter.com/_phzn) e [Rachel Nabors](https://twitter.com/rachelnabors) por compartilhar sua experiência em execução da Women of React Conf.
...
Obrigado a [Dan Lebowitz](https://twitter.com/lebo) por ajudá-lo a projetar e construir o site da conferência e os ingressos.

Obrigado a Laura Podolak Waddell, Desmond Osei-Acheampong, Mark Rossi, Josh Toberman e outros da equipe de Produções de Vídeo do Facebook por gravar os vídeos da palestra principal e das palestras dos funcionários da Meta.
