...
Assim como o Svelte tem o Sveltekit, o Vue tem o Nuxt e o Solid tem o SolidStart, o [React recomenda o uso de um framework](#why-we-recommend-frameworks) que integre totalmente o roteamento em recursos como data-fetching e code-splitting pronto para uso. Isso evita o incômodo de precisar escrever suas próprias configurações complexas e, essencialmente, construir um framework para si mesmo.
...
Mas fazer isso significa que os dados são buscados após a renderização do componente, o que pode causar "network waterfalls" (quedas de rede). Network waterfalls são causadas pela busca de dados quando seu aplicativo renderiza em vez de em paralelo enquanto o código está sendo baixado:
