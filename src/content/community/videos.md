...
Assista à keynote completa de [Andrew Clark](https://twitter.com/acdlite), [Juan Tejada](https://twitter.com/_jstejada), [Lauren Tan](https://twitter.com/potetotes) e [Rick Hanlon](https://twitter.com/rickhanlonii) aqui:
...
Para o React 18, criamos nosso primeiro Grupo de Trabalho para colaboração com um painel de especialistas, desenvolvedores, mantenedores de biblioteca e educadores. Juntos, trabalhamos para criar nossa estratégia de adoção gradual e refinar novas APIs como `useId`, `useSyncExternalStore` e `useInsertionEffect`.
...
Para dar suporte aos novos recursos nesta versão, também anunciamos a recém-formada equipe React DevTools e um novo Timeline Profiler para ajudar os desenvolvedores a depurar seus aplicativos React.
...
Olhando mais para o futuro, [Xuan Huang (黄玄)](https://twitter.com/Huxpro) compartilhou uma atualização da nossa pesquisa do React Labs sobre um compilador auto-memoizing. Confira esta palestra para obter mais informações e uma demonstração do protótipo do compilador:
...
A palestra de Pete Hunt na JSConf EU 2013 aborda três tópicos: descartar a noção de templates e criar visualizações com JavaScript, "re-renderizar" todo o seu aplicativo quando seus dados mudam e uma implementação leve do DOM e eventos - (2013 - 0h30m).
