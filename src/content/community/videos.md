...
Vídeos dedicados à discussão de React e do ecossistema React.

</Intro>

## React Conf 2021 {/*react-conf-2021*/}

### Keynote do React 18 {/*react-18-keynote*/}
...
### Ferramentas do Desenvolvedor React {/*react-developer-tooling*/}
...
Olhando para o futuro, [Xuan Huang (黄玄)](https://twitter.com/Huxpro) compartilhou uma atualização de nossa pesquisa do React Labs em um compilador de auto-memoização. Assista a esta palestra para obter mais informações e uma demonstração do protótipo do compilador:

<YouTubeIframe src="https://www.youtube.com/embed/lGEMwh32soc" title="YouTube video player" />

### Keynote dos docs do React {/*react-docs-keynote*/}

[Rachel Nabors](https://twitter.com/rachelnabors) deu início a uma seção de palestras sobre aprendizado e design com o React, com uma keynote sobre nosso investimento nos novos docs do React ([agora enviados como react.dev](/blog/2023/03/16/introducing-react-dev)):
...
A palestra de Pete Hunt na JSConf EU 2013 aborda três tópicos: descartar a noção de templates e construir visualizações com JavaScript, "re-renderizar" todo o seu aplicativo quando seus dados mudam e uma implementação leve do DOM e eventos - (2013 - 0h30m).
...
Tom Occhino e Jordan Walke apresentam React na Facebook Seattle - (2013 - 1h20m).
