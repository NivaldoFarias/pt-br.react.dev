...
Na keynote, compartilhamos nossa visão para o futuro do React começando com o React 18.

Assista a keynote completa de [Andrew Clark](https://twitter.com/acdlite), [Juan Tejada](https://twitter.com/_jstejada), [Lauren Tan](https://twitter.com/potetotes) e [Rick Hanlon](https://twitter.com/rickhanlonii) aqui:
...
React 18 também inclui melhorias de performance para renderização do lado do servidor usando Suspense.

O streaming server rendering permite que você gere HTML de componentes React no servidor e transmita esse HTML para seus usuários. No React 18, você pode usar `Suspense` para dividir seu aplicativo em unidades menores e independentes que podem ser transmitidas de forma independente umas das outras, sem bloquear o resto do aplicativo. Isso significa que os usuários verão seu conteúdo mais cedo e poderão começar a interagir com ele muito mais rápido.
...
Olhando para o futuro, [Xuan Huang (黄玄)](https://twitter.com/Huxpro) compartilhou uma atualização de nossa pesquisa do React Labs em um compilador de auto-memoização. Confira esta palestra para obter mais informações e uma demonstração do protótipo do compilador:
...
[Rachel Nabors](https://twitter.com/rachelnabors) iniciou uma seção de palestras sobre aprendizado e design com React com uma keynote sobre nosso investimento nos novos documentos do React ([agora enviados como react.dev](/blog/2023/03/16/introducing-react-dev)):
...
* Daishi Kato: [React 18 para Bibliotecas de Loja Externa](https://youtu.be/oPfSC5bQPR8).
...
A palestra de Pete Hunt na JSConf EU 2013 aborda três tópicos: descartar a noção de templates e construir visualizações com JavaScript, "re-renderizando" todo o seu aplicativo quando seus dados mudam, e uma implementação leve do DOM e eventos - (2013 - 0h30m).
