...
Na palestra principal, compartilhamos nossa visão para o futuro do React a partir do React 18.
...
Para apoiar os novos recursos nesta versão, também anunciamos a recém-formada equipe do React DevTools e um novo Profilador de Linha do Tempo para ajudar os desenvolvedores a depurar seus aplicativos React.
...
Olhando mais para o futuro, [Xuan Huang (黄玄)](https://twitter.com/Huxpro) compartilhou uma atualização de nossa pesquisa nos Laboratórios do React sobre um compilador de memoização automática. Confira esta palestra para mais informações e uma demonstração do protótipo do compilador:
...
[Rachel Nabors](https://twitter.com/rachelnabors) abriu uma seção de palestras sobre aprendizado e design com o React com uma palestra sobre nosso investimento na nova documentação do React ([agora disponibilizada como react.dev](/blog/2023/03/16/introducing-react-dev)):

<YouTubeIframe src="https://www.youtube.com/embed/mneDaMYOKP8" title="YouTube video player" />

### E mais... {/*and-more*/}

**Nós também ouvimos palestras sobre aprendizado e design com o React:**
...
* Linton Ye: [O Retorno sobre Investimento de Projetar com o React](https://youtu.be/7cPWmID5XAk).
* Delba de Oliveira: [Praças de testes interativas com React](https://youtu.be/zL8cz2W0z34).
...
A palestra de Pete Hunt no JSConf EU 2013 aborda três tópicos: descartar a noção de templates e construir visões com JavaScript, “re-renderizar” toda sua aplicação quando seus dados mudam, e uma implementação leve do DOM e eventos - (2013 - 0h30m).
