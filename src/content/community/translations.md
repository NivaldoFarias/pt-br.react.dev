...
{/* Se você é um responsável pela tradução de um idioma e deseja adicionar seu idioma aqui, finalize as traduções "Core" e edite `deployedTranslations` em `src/utils`. */}

<LanguageList progress="complete" />

## Traduções em andamento {/*in-progress-translations*/}

Para acompanhar o progresso de cada tradução, consulte: [O React já foi traduzido?](https://translations.react.dev/)
...
A comunidade conduz o trabalho de tradução da documentação do React em cada fork de react.dev específico para cada idioma. O trabalho típico de tradução envolve a tradução direta de um arquivo Markdown e a criação de um pull request. Clique no link "contribuir" acima para o repositório do GitHub do seu idioma e siga as instruções para ajudar no esforço de tradução.
