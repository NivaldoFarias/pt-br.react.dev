...
export default function Form() {
  ...
  return (
    <>
      <MyInput ref={inputRef} />
      <button onClick={handleClick}>Focar o campo de entrada</button>
    </>
  );
}
```
...
Considere um código como este, que adiciona