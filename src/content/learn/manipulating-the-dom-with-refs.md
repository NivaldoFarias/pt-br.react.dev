...
<Pitfall>
Refs são uma saída de emergência. Manipular manualmente nós DOM de _outro_ componente pode tornar seu código frágil.
</Pitfall>
...
Isso instruirá o React a atualizar o DOM de forma síncrona logo após a execução do código envolvido por `flushSync`. Como resultado, o último item da lista já estará no DOM no momento em que você tentar rolar para ele:
...
- Se você modificar nós do DOM gerenciados pelo React, modifique partes que o React não tem motivo para atualizar.
