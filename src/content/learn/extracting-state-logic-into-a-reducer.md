...
É na função reducer que você colocará sua lógica de estado. Ela recebe dois argumentos, o estado atual e o objeto de ação, e retorna o próximo estado:
...
Para mover a lógica de definição de estado dos seus manipuladores de eventos para uma função reducer neste exemplo, você irá:

1. Declarar o estado atual (`tasks`) como o primeiro argumento.
2. Declarar o objeto `action` como o segundo argumento.
3. Retornar o _próximo_ estado do reducer (que o React definirá como estado).
...
Nós as usaremos em toda a documentação restante como segue:
