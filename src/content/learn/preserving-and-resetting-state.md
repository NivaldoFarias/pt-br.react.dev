...
Ao voltar, o `div` é deletado e a nova `section` é adicionada
...
Dê `key={selectedId}` ao componente `EditContact`. Dessa forma, alternar entre contatos diferentes irá redefinir o formulário:
