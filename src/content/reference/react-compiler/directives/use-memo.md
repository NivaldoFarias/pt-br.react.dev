...
Quando uma função contém `"use memo"`, o React Compiler a analisará e otimizará durante o tempo de compilação. O compilador memorizará automaticamente valores e componentes para evitar recálculos e re-renderizações desnecessárias.
...
O comportamento de `"use memo"` muda com base na configuração do seu compilador:
