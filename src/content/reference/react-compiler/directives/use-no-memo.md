...
O compilador trata essas funções como se o React Compiler não estivesse ativado, deixando-as exatamente como foram escritas.
...
function WrapperDeTerceiros() {
  ...
  useTerceiroHook(); // Possui efeitos colaterais que o compilador pode otimizar incorretamente
  // ...
}
```
