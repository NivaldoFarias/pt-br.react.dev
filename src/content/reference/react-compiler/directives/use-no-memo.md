...
O React Compiler analisa seu código em tempo de compilação para aplicar otimizações. `"use no memo"` cria um limite explícito que informa ao compilador para ignorar completamente uma função.
