...
### Como `"use no memo"` opta por não participar da otimização {/*how-use-no-memo-opts-out*/}
...
function WrapperDeTerceiros() {
  ...
  useTerceiroHook(); // Tem efeitos colaterais que o compilador pode otimizar incorretamente
  // ...
}
```
