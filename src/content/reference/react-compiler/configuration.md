...
Para a maioria dos aplicativos, as opções padrão devem funcionar imediatamente. Se você tiver uma necessidade especial, poderá usar estas opções avançadas.
