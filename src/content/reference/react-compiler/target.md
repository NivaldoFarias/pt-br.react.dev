...
### Alvo React 19 (padrão) {/*targeting-react-19*/}
...
### Alvo React 17 ou 18 {/*targeting-react-17-or-18*/}
...
O compilador usará o runtime polyfill para ambas as versões:
...
Para verificar se o runtime correto está sendo usado, observe a importação diferente (`react/compiler-runtime` para integrado, pacote autônomo `react-compiler-runtime` para 17/18):
