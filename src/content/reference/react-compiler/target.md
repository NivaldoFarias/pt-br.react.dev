...
### Destinando ao React 19 (padrão) {/*targeting-react-19*/}
...
### Destinando ao React 17 ou 18 {/*targeting-react-17-or-18*/}
...
```js
// A saída compilada usa o runtime de polyfill
import { c as _c } from 'react-compiler-runtime';
```
...
Para verificar se o runtime correto está sendo usado, observe a importação diferente (`react/compiler-runtime` para o integrado, `react-compiler-runtime` pacote autônomo para 17/18):
