...
<Intro>
Este guia ajuda autores de bibliotecas a entender como usar o Compilador React para entregar código de biblioteca otimizado aos seus usuários.
</Intro>
...
- **Melhorias de performance para todos os usuários** - Seus usuários da biblioteca obtêm código otimizado, mesmo que ainda não estejam usando o Compilador React.
...
Adicione o Compilador React ao processo de build da sua biblioteca:
...
Alguns plugins do Babel podem entrar em conflito com o Compilador React:
