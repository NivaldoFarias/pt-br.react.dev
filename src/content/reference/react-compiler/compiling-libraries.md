...
<Intro>
Este guia ajuda autores de bibliotecas a entender como usar o React Compiler para distribuir código de biblioteca otimizado para seus usuários.
</Intro>

<InlineToc />

## Por que Distribuir Código Compilado? {/*why-ship-compiled-code*/}
...
- **Nenhuma configuração necessária pelos usuários** - As otimizações funcionam "out of the box".
...
3. Teste o resultado do seu build minuciosamente.
...
2. Verifique se o seu bundler inclui o runtime na saída.
