...
Diretivas do Compilador React fornecem controle granular sobre quais funções são otimizadas pelo compilador. São literais de string colocados no início do corpo de uma função ou no topo de um módulo.
...
// Mais tarde, mude para o modo infer e exclua os problemáticos
