...
A opção `logger` fornece um registro personalizado para eventos do React Compiler durante a compilação.
...
Configura um registro personalizado para rastrear o comportamento do compilador e depurar problemas.
