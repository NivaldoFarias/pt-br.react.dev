...
[Frameworks baseados em React](/learn/start-a-new-react-project) frequentemente cuidam do carregamento de recursos para você, então você pode não precisar chamar essas APIs. Consulte a documentação do seu framework para obter detalhes.
