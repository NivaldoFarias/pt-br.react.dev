...
Se múltiplos tipos corresponderem, eles serão unidos. Se nenhum tipo corresponder, a entrada "default" especial será usada em vez disso. Se algum tipo tiver o valor "none", ele prevalecerá e a ViewTransition será desativada (não terá nome atribuído).
