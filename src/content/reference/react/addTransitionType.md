...
No futuro, planejamos suportar mais casos de uso para a causa de uma transição.

---
### Personalizar animações usando tipos de transição de visualização do navegador {/*customize-animations-using-browser-view-transition-types*/}

Quando um [`ViewTransition`](/reference/react/ViewTransition) é ativado a partir de uma transição, o React adiciona todos os Tipos de Transição como [tipos de transição de visualização do navegador](https://www.w3.org/TR/css-view-transitions-2/#active-view-transition-pseudo-examples) ao elemento.
...
Se múltiplos tipos corresponderem, eles serão unidos. Se nenhum tipo corresponder, a entrada especial "default" será usada em vez disso. Se algum tipo tiver o valor "none", ele prevalecerá e o ViewTransition será desabilitado (não receberá um nome).
